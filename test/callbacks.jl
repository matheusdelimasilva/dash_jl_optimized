...
@testset "callback! single output" begin
    ...
    @test app.callbacks[Symbol("my-div.children")][1].func("test") == "test"
...
@testset "callback! multi output" begin
    ...
    @test app.callbacks[Symbol("..my-div.children...my-div2.children..")][1].func("value", "state") == ("value", "state")
    ...
    @test length(app.callbacks) == 1
    @test haskey(app.callbacks, Symbol("..my-div.children.."))
    @test app.callbacks[Symbol("..my-div.children..")][1].func("value", "state") == ("value", )
...
@testset "callback! multi output flat" begin
    ...
    @test length(app.callbacks) == 1
    @test haskey(app.callbacks, Symbol("..my-div.children...my-div2.children.."))
    @test app.callbacks[Symbol("..my-div.children...my-div2.children..")][1].func("value", " value2", "state") == ("value value2", "state")
    ...
    @test length(app.callbacks) == 1
    @test haskey(app.callbacks, Symbol("my-div.children"))
    @test app.callbacks[Symbol("my-div.children")][1].func("value", " value2") == "value value2"
...
@testset "callback! multi output same component id" begin
    ...
    @test app.callbacks[Symbol("..input-two.placeholder...input-two.type..")][1].func("text") == ("text ??", "text")
...
@testset "callback! checks" begin
    ...
    @test app.callbacks[Symbol("my-div.children")][1].func("value") == "value"
    @test app.callbacks[Symbol("my-div2.children")][1].func("value") == "v_value"
...
@testset "multiple callbacks targeting same output" begin
    ...
    # This should fail without allow_duplicate=true
    testresult = @test_throws ErrorException callback!(app, Output("my-div","children"), Input("my-id2","value")) do value
        return "v_$(value)"
    end
    @test occursin("Multiple callbacks can not target the same output", testresult.value.msg)
    @test occursin("allow_duplicate=true", testresult.value.msg)
    
    # Now test with allow_duplicate=true
    callback!(app, Output("my-div","children"), Input("my-id2","value"), allow_duplicate=true) do value
        return "v_$(value)"
    end
    
    # Now we should have 2 callbacks for the same output
    @test length(app.callbacks[Symbol("my-div.children")]) == 2
    @test app.callbacks[Symbol("my-div.children")][1].func("test") == "test"
    @test app.callbacks[Symbol("my-div.children")][2].func("test") == "v_test"
end
...
@testset "clientside callbacks function" begin
    ...
    @test length(app.callbacks) == 1
    @test haskey(app.callbacks, Symbol("my-div.children"))
    @test app.callbacks[Symbol("my-div.children")][1].func isa ClientsideFunction
    @test app.callbacks[Symbol("my-div.children")][1].func.namespace == "namespace"
    @test app.callbacks[Symbol("my-div.children")][1].func.function_name == "func_name"
...
@testset "clientside callbacks string" begin
    ...
    @test haskey(app.callbacks, Symbol("my-div.children"))
    @test app.callbacks[Symbol("my-div.children")][1].func isa ClientsideFunction
    @test app.callbacks[Symbol("my-div.children")][1].func.namespace == "_dashprivate_my-div"
    @test app.callbacks[Symbol("my-div.children")][1].func.function_name == "children"
